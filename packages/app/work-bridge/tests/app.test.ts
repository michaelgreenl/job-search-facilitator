...
import type { StartWorkTaskInput, WorkTaskEvent } from '@job-search-facilitator/core'
...
const parseEventStream = (body: string): Array<{ id: number; event: WorkTaskEvent }> =>
    body
        .trim()
        .split('\n\n')
        ...
        .map((frame) => {
            ...
            return {
                ...
                event: JSON.parse(data.slice(6)) as WorkTaskEvent,
            }
        })
